...
class exmple {
    public static void main(String[] args) throws DocumentException
    {
        ...
        Document document = reader.read(new File("C:\\springbootSpaceB\\springboot-plus\\admin-core\\src\\main\\java\\com\\ibeetl\\test\\test.xml"));
        ...
        System.out.println("id:"+conElem.attribute("id").getValue());
